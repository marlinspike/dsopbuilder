[![Continuous Build, Test, Deploy](https://github.com/marlinspike/dsopbuilder/actions/workflows/docker-build.yml/badge.svg?branch=main)](https://github.com/marlinspike/dsopbuilder/actions/workflows/docker-build.yml)
